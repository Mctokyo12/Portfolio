...
const Hero = memo(() => {
  ...
  return (
    <header className=' md:h-[698.87px]  max-md:h-158  mt-28 md:mt-36  '>

      <div className=' md:mx-37.5 mx-5'>
        <div className=' absolute hidden lg:block  left-6  top-42'>
          <img src={Vector} alt=""  />
        </div>
      
        <div className=' relative'>
          <span className='heading_four text-primary   '>Hello ,</span>
          <div className=' grid md:grid-cols-2 w-full   grid-cols-1  place-content-between'>
            ...
            <div className='flex flex-col  ' data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
              <div className='md:w-[80%] '>
                ...
                <p className='heading_meduim text-text/60 w-full text-justify' >A talent team  to help you in your journey on creating useful and easy  to use product</p>
              </div>
              
              <div className=' flex flex-col  md:flex-row  items-center mt-14   gap-5'>
            ...
            <div className='hidden lg:block self-start absolute  -right-38  top-0 w-[778.94px]   h-[698.87px] '  data-aos="fade-up" data-aos-duration="3000">
