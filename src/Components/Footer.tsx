            ...
            <div className='flex items-start justify-around'>
                <div className='w-[45%] flex  items-start gap-20'>
                    ...
                    <div className='flex-col items-start md:flex hidden  w-full'>
                        <h3 className='text-black dark:text-white heading_meduim mb-7'>About</h3>
                        <ul className='flex flex-col gap-5 items-start '>
                            <li className='heading_regular  text-black/80'>About Us</li>
                            <li className='heading_regular  text-black/80'>Study Case</li>
                            <li className='heading_regular  text-black/80'>Blogs</li>
                            <li className='heading_regular  text-black/80'>Portfolio</li>
                            <li className='heading_regular  text-black/80'>Careers</li>
                ...
                <div className='flex flex-col md:flex-row items-center  justify-around gap-50'>
                    ...
                    <div className='md:flex flex-col  hidden items-start'>
                        <h3 className='text-black dark:text-white heading_meduim mb-7'>Follow Us</h3>
                        <ul className='flex flex-col gap-5 items-start'>
                            <li className='heading_regular  text-black/80 flex items-center gap-2.25'>
                                <FaFacebook className='size-7  text-primary'/>
                                <span className='heading_regular text-black dark:text-white'>fb.com/SetupAI</span>
                            </li>
                            <li className='heading_regular  text-black/80 flex items-center gap-2.25'>
                                <FaInstagram className='size-7  text-primary'/>
                                <span className='heading_regular text-black dark:text-white'>@SetupAI</span>
                            </li>
                            <li className='heading_regular  text-black/80 flex items-center gap-2.25'>
